...
interface Props extends PressableProps {
  ...
  variant?: 'containded' | 'text-only';
  className?: string;
}

const CustomButton = React.forwardRef(({ children, color = "primary", onPress, onLongPress, variant = "containded", className}: Props, ref: React.Ref<View>) => {
